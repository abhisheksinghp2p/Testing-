...
Guided media uses physical cables to transmit data.
- Data travels through wires or cables
- More secure and stable
- Faster and less interference
...
Unguided media transmits data through air (no cables).
- Uses radio waves, microwaves, or signals
- No physical connection needed
- Easy to install but less secure
