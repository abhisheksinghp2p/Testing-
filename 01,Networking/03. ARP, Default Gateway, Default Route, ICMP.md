...
- ==A default route is a route used to forward packets when no specific route for the destination network is found in the routing table.==
...
- ==ICMP is a protocol used for error reporting and network diagnostics in IP networks.==
